        ...
        <footer className="bg-gray-100 mt-10">
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <ul className="mt-12 flex justify-center gap-6 md:gap-8">
                    <li>
                        <a
                            href="https://facebook.com/yourpage" // Замените на ваш реальный URL
                    ...
                    <li>
                        <a
                            href="https://instagram.com/yourprofile" // Замените на ваш реальный URL
                            rel="noopener noreferrer" // Добавлено для безопасности
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
                    ...
                    <li>
                        <a
                            href="https://twitter.com/yourprofile" // Замените на ваш реальный URL
                            rel="noopener noreferrer" // Добавлено для безопасности
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
                    ...
                    <li>
                        <a
                            href="https://github.com/yourprofile" // Замените на ваш реальный URL
                            rel="noopener noreferrer" // Добавлено для безопасности
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
                    ...
                    <li>
                        <a
                            href="https://dribbble.com/yourprofile" // Замените на ваш реальный URL
                            rel="noopener noreferrer" // Добавлено для безопасности
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
